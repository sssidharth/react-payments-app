...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  const [tabs, setTabs] = useState([
    ...
    {
        name: 'Transactions',
        icon: <FontAwesomeIcon className="size-5 mr-4" icon={faMoneyBillTransfer} />,
        active: false,
        path: "/transactions"
    },
    {
    ...
    {
        name: 'Investments',
        icon: <FontAwesomeIcon className="size-5 mr-4" icon={faMoneyBillTrendUp} />,
        active: false,
        path: "/investments"
    },
    {
    ...
    {
        name: 'Loans',
        icon: <FontAwesomeIcon className="size-5 mr-4" icon={faHandHoldingDollar} />,
        active: false,
        path: "/loans"
    },
    {
        name: 'Services',
        icon: <FontAwesomeIcon className="size-5 mr-4" icon={faScrewdriverWrench} />,
        active: false,
        path: "/services"
    },
    {
  ...
  const renderTabs = (tab, index) => {
        return (
            ...
            {tab.active ? <p className="h-full w-2.5 rounded-r-lg bg-black"></p> : null}
              <NavLink onClick={() => handleTabChange(tab.name)} to={tab.path} className={({ isActive }) => 
    ...
    <div className="flex">
      ...
      >
        <div>
          ...
          <FontAwesomeIcon onClick={toggleSidebar} icon={faClose} className="ml-7 md:hidden text-gray-500 hover:font-semibold hover:text-black cursor-pointer"/>
          </div>
